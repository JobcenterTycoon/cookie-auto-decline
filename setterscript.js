...
(function () {
   if ((sessionStorage.getItem('mpowlesu908hxfyw37ghg5ikx90jdzt') != "djx0v0odce35xrb2pt5dzbgaj1mud5c" && (window.innerHeight > 400 || window.innerHeight === 0)) && document.querySelector('body[class="no-js"] > .main-wrapper[role="main"] + script') === null && document.querySelector('html[style="height:100%"] iframe[src^="/_Incapsula_Resource?"]') === null && document.querySelector('link[href="/cdn-cgi/styles/challenges.css"][rel="stylesheet"]') === null && window.location.hostname != 'accounts.google.com') {
      ...
      const cookiezeit = datum.getTime();
      ...
      const regeln = [{
         ...
         seite: 'likehifi.de',
         setcookie: 'consentUUID=9f9ccda5-c4b8-49bf-973c-3470fb663bbc_32_33_34_36_37;'
      }, {
         seite: 'faszination-fankurve.de',
         setcookie: 'consentUUID=8ec72931-7f30-41ee-8e7a-3eeed042376e_32_33_36_37;'
      }, {
         ...
         seite: 'cinestar.de',
         setcookie: 'consentUUID=797b7d14-32c2-4a40-9935-9404824101d1_34_37;'
      }, {
         ...
         seite: 'oracle.com,trustarc.com,samsung.com,flickr.com,hostelworld.com,juniper.net,css-tricks.com,concursolutions.com,ibmcloud.com',
         ...
         seite: 'bmwk.de,bmwk-energiewende.de',
         ...
         seite: 'dasgehirn.info,mademyday.com,lumedis.de',
         ...
         seite: 'kuechenprofi-markenshop.de',
         setcookie: 'cookie-preference=1;'
      }, {
         seite: 'oklo.com',
         setcookie: 'cookiemonster-gdpr=' + cookiezeit + ';'
      }, {
         seite: 'kuechenprofi-mdarkenshop.de',
         setcookie: 'cookie-preference=1;'
      }, {
         ...
         seite: 'sephora.de',
         setcookie: 'TC_PRIVACY=1%40005%7C17%7C3650%40%401%401726942787947%2C1726942787947%2C1742494787947%40AiQ%3D;'
      }, {
         ...
         seite: 'ilockit.bike',
         setcookie: '_bc_c_set=eyJkYXRlIjoxNzI2OTQzNDI1NzczLCJ2ZXJzaW9uIjoyMDIwMTIxNjIyNTEwNywidHlwZV8wIjp7InRydWUiOjEsImZhbHNlIjowfSwidHlwZV8xIjp7InRydWUiOjAsImZhbHNlIjoxfSwidHlwZV8yIjp7InRydWUiOjAsImZhbHNlIjoxfX0=;'
      }, {
         seite: 'pcloud.link',
         ...
         seite: 'livarea.de',
         setcookie: 'cookie-preference=1; , dvsn-persistent-cart=1; , moorl-location-map=1; , wishlist-enabled=1;'
      }, {

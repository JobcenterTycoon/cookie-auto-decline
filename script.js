                     ...
                     for (let i = 0; i < einstellungenknöpfe.length; i++) {
                        ...
                        if (getComputedStyle(a).getPropertyValue('display') !== 'none' && getComputedStyle(a).getPropertyValue('visibility') !== 'hidden') {
                           ...
                           if (einstellungenknöpfe[i].parentElement.parentElement.querySelector('.required-consent')) {
                              if (einstellungenknöpfe[i].innerText.toLowerCase().trim() === 'zustimmen') {
                                 a.click();
                              }
                           } else {
                              a.click();
               ...
               if (erweitertecookiebannererkennungaktiviert === true && altererkennungsscriptausgeführt === false) {
                  ...
                  if (advancedslowdown === 0) {
                     ...
                     for (let i = 0; i < elemente.length; i++) {
                        ...
                        if (elementtext && elementtext.length >= 50 && elementtext.length < 3500 && (elementhtml.includes('cookie') || elementhtml.includes('privacy policy') || elementhtml.includes('privacy-policy') || elementhtml.includes('datenschutzerklärung') || elementhtml.includes('datenschutzeinstellung') || (document.documentElement.lang && (webseitesprache === 'tr' && (elementtext.includes('çerezler') || elementtext.includes('verilerin korunması'))) || (webseitesprache === 'fi' && elementtext.includes('tietosuojalauseke'))))) {
                           // console.log(elemente[i])
